...
def format_rule(rule):
    ...
    labels = {
        ...
        "odds_min": "odds â¥",
        "odds_max": "odds â¤",
        "median_odds_min": "median odds â¥",
        "median_odds_max": "median odds â¤",
        "bookmakers_min": "bookmakers â¥",
        "total_games_min": "total games â¥",
        "total_games_max": "total games â¤",
    }
...
def make_report(generated_at, source_rows, baseline, best, top_rows, best_rows, train_stats, test_stats, breakdowns):
    ...
    lines.append("```")
    lines.append("")
    lines.append("Suggested live stake while testing: **0.25uâ0.5u flat** until at least 50 new forward-test rows.")
    lines.append("")
